...
Promise.all([reachA,reachB,reachC])//if any one rejected show that only
...
.then((message)=>console.log(message))//if any one resolved show that only
.catch((message)=>console.log(message))
